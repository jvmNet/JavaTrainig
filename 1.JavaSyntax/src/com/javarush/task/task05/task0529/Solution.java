...
2. Программа должна прекращать считывать данные с клавиатуры после того пользователь
введет слово «сумма» в нижнем регистре и нажмет Enter.
...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        final String wordExit = "сумма";
        int sum = 0;
        while(true) {
            String inputStream = bufferedReader.readLine();
            if(inputStream.equals(wordExit))
                break;
            sum+= Integer.parseInt(inputStream);
        }

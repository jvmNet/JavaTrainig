...
5. В классах Hrivna, Ruble и USD реализуй публичный(public) конструктор, который принимает
один параметр и вызывает конструктор базового класса(super) с этим параметром.
...
public class Solution {
    ...
    static class Person {
        ...
        Person(String name) {
            ...
            this.allMoney.add(new USD(150));
            this.allMoney.add(new Ruble(25000));
            this.allMoney.add(new Hrivna(30000));
